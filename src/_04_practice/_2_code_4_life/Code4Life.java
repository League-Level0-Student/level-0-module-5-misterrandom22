...
String coding = JOptionPane.showInputDialog("how may hours have you spent coding this week?");
int codingTime = Integer.parseInt(coding);
...
else if(codingTime>=3 && codingTime <= 5) {
